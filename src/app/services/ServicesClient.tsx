...
const fallbackPageData = {
  ...
  heroTitle: 'Digital Solutions That Drive Growth',
  heroHighlight: 'Drive Growth',
  heroDescription: 'Comprehensive digital services designed to transform your business into a market leader in the AI-powered era.',
  heroButtonText: 'Start Your Project',
  heroSecondaryButtonText: 'Get Free Audit',
  overviewSubtitle: 'WHAT WE DO',
  overviewTitle: 'Full-Stack Digital Services',
  overviewDescription: 'From concept to execution, we deliver end-to-end solutions that power business growth',
  processSubtitle: 'OUR PROCESS',
  processTitle: 'How We Work With You',
  processDescription: 'A proven methodology that delivers results',
  processSteps: [
    { step: '01', title: 'Discovery', description: 'Understanding your business, goals, and challenges', icon: 'Search' },
    { step: '02', title: 'Strategy', description: 'Creating a tailored digital roadmap', icon: 'Target' },
    { step: '03', title: 'Execution', description: 'Building and implementing solutions', icon: 'Code' },
    { step: '04', title: 'Growth', description: 'Optimizing for continuous improvement', icon: 'TrendingUp' }
  ],
  ctaTitle: 'Ready to Start Your Project?',
  ctaDescription: "Let's discuss how our services can help transform your business.",
  ctaButtonText: 'Contact Us',
  ctaSecondaryButtonText: 'Get Free Audit'
};
...
export default function ServicesClient({ pageData, services }: ServicesClientProps) {
  const page = { ...fallbackPageData, ...pageData };
  const servicesList = services && services.length > 0 ? services : fallbackServices;
    ...
    <div className="overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              {page.heroTitle?.replace(page.heroHighlight || '', '') || 'Digital Solutions That '}{' '}
      ...
      <section className="py-24 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <span className="text-[#F15924] font-semibold mb-4 block">{page.overviewSubtitle}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            {processSteps.map((item, index) => {
              const IconComponent = processIconMap[item.icon] || Search;
              return (
                <motion.div
                  key={index}
                  variants={fadeInUp}
