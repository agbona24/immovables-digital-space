          ...
          >
            <div className="grid lg:grid-cols-2">
              ...
              <div className="relative hidden lg:block">
                <div className={`absolute inset-0 bg-gradient-to-br ${articles[0].gradient}`} />
                  ...
                  >
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">AI Business Trends</p>
                      </div>
                    </div>
            ...
            {filteredArticles.slice(activeCategory === 'All' ? 1 : 0).map((article, index) => (
              ...
              >
                <div className={`h-48 bg-gradient-to-br ${article.gradient} relative overflow-hidden`}>
                  ...
                  >
                    <article.icon size={64} className="text-white/30" />
                  </motion.div>
                  {/* Category Badge */}
