...
const fallbackPageData = {
  heroSubtitle: 'AI-Powered Business Solutions',
  heroTitle: 'Transform Your Business with',
  heroHighlight: 'AI Automation',
  heroDescription: 'Harness the power of artificial intelligence to automate customer interactions, qualify leads, and scale your operations without limits.',
  heroButtonText: 'Get AI Solutions',
  heroSecondaryButtonText: 'Free AI Assessment',
  solutionsSubtitle: 'OUR AI SOLUTIONS',
  solutionsTitle: 'AI Systems Built for Business Growth',
  solutionsDescription: 'Cutting-edge AI solutions designed to automate operations, enhance customer experience, and drive revenue.',
  processSubtitle: 'HOW IT WORKS',
  processTitle: 'Getting Started with AI',
  processSteps: [
    { step: '1', title: 'Assessment', description: 'We analyze your current processes and identify AI opportunities', icon: 'BarChart' },
    { step: '2', title: 'Strategy', description: 'Custom AI implementation plan aligned with your goals', icon: 'Brain' },
    { step: '3', title: 'Implementation', description: 'We build and deploy your AI systems with thorough testing', icon: 'Settings' },
    { step: '4', title: 'Optimization', description: 'Continuous improvement based on performance data', icon: 'TrendingUp' }
  ],
  useCasesSubtitle: 'USE CASES',
  useCasesTitle: 'AI Solutions for Every Industry',
  useCases: [
  ...
  ctaDescription: 'Get a free AI assessment and discover how automation can transform your operations.',
  ctaButtonText: 'Schedule Consultation',
  ctaSecondaryButtonText: 'Get Free Assessment'
};
...
interface AiSolutionsClientProps {
  pageData: PageData | null;
  aiSolutions: AiSolution[] | null;
  benefits: Benefit[] | null;
}

export default function AiSolutionsClient({ pageData, aiSolutions, benefits }: AiSolutionsClientProps) {
  const page = { ...fallbackPageData, ...pageData };
  const solutions = aiSolutions && aiSolutions.length > 0 ? aiSolutions : fallbackAiSolutions;
  const benefitsList = benefits && benefits.length > 0 ? benefits : fallbackBenefits;
  const processSteps = page.processSteps || fallbackPageData.processSteps;
  const useCases = page.useCases || fallbackPageData.useCases;
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm text-gray-300">{page.heroSubtitle}</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/contact" className="btn-primary flex items-center justify-center gap-2">
                  {page.heroButtonText} <ArrowRight size={18} />
                </Link>
      ...
      <section className="py-24 relative" style={{ backgroundImage: 'url(/hero2.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              {page.solutionsDescription}
            </motion.p>
          </motion.div>

          <div className="space-y-0">
            {solutions.map((solution, index) => {
              const Widget = solutionWidgets[index % solutionWidgets.length];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            {processSteps.map((item, index) => {
              const IconComponent = iconMap[item.icon] || BarChart;
              return (
                <motion.div
                  key={index}
                  variants={fadeInUp}
          ...
          >
            ...
            >
              <Link href="/contact" className="bg-white text-[#F15924] px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 hover:scale-105 transition-all flex items-center justify-center gap-2">
                {page.ctaButtonText} <ArrowRight size={18} />
              </Link>
