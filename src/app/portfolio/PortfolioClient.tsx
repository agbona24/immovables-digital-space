...
const categoryGradients: Record<string, string> = {
  'Web Development': 'from-[#F15924] to-[#FF4924]',
  'Business Software': 'from-[#2563EB] to-[#60a5fa]',
  'AI Automation': 'from-[#0A2540] to-[#0F172A]',
  'E-commerce': 'from-[#F15924] to-[#FF4924]',
  'Digital Marketing': 'from-[#10B981] to-[#34D399]',
};
...
export default function PortfolioClient({ projects: sanityProjects }: PortfolioClientProps) {
  const [activeCategory, setActiveCategory] = useState('All');

  // Transform Sanity projects to match the expected format, or use fallback
  const projects = sanityProjects.length > 0 ? sanityProjects.map(project => ({
    title: project.title,
    category: project.category || 'Web Development',
    industry: project.client || 'Technology',
    description: project.description || '',
    results: project.results || [],
    gradient: categoryGradients[project.category || 'Web Development'] || 'from-[#0A2540] to-[#0F172A]',
